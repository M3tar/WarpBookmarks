...
当前版本为 `0.2.2`：已经可以记录和搜索个人书签、打开传送手册、返回住宅、使用原版默认地点、返回上一个位置，并从支持搜索的已到访地图下拉列表中选择目标，输入 X/Y 后预览、传送或保存精准坐标。控制台仍可使用 `wb_warp <location> <x> <y>`。
...
- [0.2.2 Windows 输入复核](docs/WINDOWS_TEST_0.2.2.md)
