...
当前版本为 `0.5.3`：已经可以记录、分类和搜索个人书签，使用“常用”首页快速返回住宅、上一个位置或收藏地点。自定义书签的内存缓存现在严格绑定存档、农场、玩家和 SMAPI 屏幕，防止在线联机存档与个人存档之间串用数据。
...
- [0.5.3 Windows 合并测试](docs/WINDOWS_TEST_0.5.3.md)
