...
当前版本为 `0.5.1`：已经可以记录、分类和搜索个人书签，使用“常用”首页快速返回住宅、上一个位置或收藏地点。右下角“传送到某地”使用与原版按钮一致的明亮启用状态；载入存档时不再弹出快捷键 HUD，菜单内仍显示当前实际配置的打开/关闭与快速记录按键。
...
- [0.5.1 Windows 合并测试](docs/WINDOWS_TEST_0.5.1.md)
