...
当前版本为 `0.4.0`：已经可以记录、分类和搜索个人书签，使用“常用”首页快速返回住宅、上一个位置或收藏地点，并从七行可搜索的已到访地图列表中选择目标，输入 X/Y 后预览、传送或先命名再保存。默认地点支持隐藏、逐个恢复或全部恢复。
...
- [0.4.0 Windows 合并测试](docs/WINDOWS_TEST_0.4.0.md)
